      ...
      <motion.div initial={{ y: 8, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">{reports.length} signalement{reports.length !== 1 ? 's' : ''}</p>
          </div>
          <button
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {report.resolution_note && (
                      <div className="mt-3 bg-brand-50 border border-brand-100 rounded-lg p-3">
                        <p className="text-xs font-semibold text-brand-700 mb-1">Réponse de l'équipe</p>
